...
const XiaomiServiceReader = require('xiaomi-gap');

const XIAOMI_CAPABILITY_TEMP = 0x04;
const XIAOMI_CAPABILITY_WATCH = 0x05;
const XIAOMI_CAPABILITY_HUMIDITY = 0x06;
const XIAOMI_CAPABILITY_BATTERY = 0x0A;
const XIAOMI_CAPABILITY_TEMP_HUMIDITY = 0x0C;
...
exports.handlers = {
 ...
 "fe95" : function(d) { 
   var r = XiaomiServiceReader.readServiceData(d);
