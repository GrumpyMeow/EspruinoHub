...
exports.init = function() {
  ...
  if (fs.existsSync(CONFIG_FILENAME)) {
    ...
    if (process.env.MQTT_HOST) {
      exports.mqtt_host = process.env.MQTT_HOST;
    }
    exports.mqtt_options = json.mqtt_options ? json.mqtt_options : {};
    if (process.env.MQTT_USER) {
      exports.mqtt_options.username = process.env.MQTT_USER;
    }
    if (process.env.MQTT_PASS) {
      exports.mqtt_options.password = process.env.MQTT_PASS;
    }
    if (process.env.MQTT_CLIENTID) {
      exports.mqtt_options.clientId = process.env.MQTT_CLIENTID;
    }
